...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handlePeliculaNotFound(ViajeNotFoundException ex) {
    ...
    public ResponseEntity<Object> handleJsonParseError(HttpMessageNotReadableException ex) {
        ...
        // Si el problema es un formato de fecha inválido
        if (cause instanceof com.fasterxml.jackson.databind.exc.InvalidFormatException
                && cause.getCause() instanceof java.time.format.DateTimeParseException) {
    
            body.put("error", "Formato de fecha inválido");
            body.put("message", "El campo 'fechaViaje' debe tener el formato dd/MM/yy");
        } else {
            // Cualquier otro error de JSON mal formado
